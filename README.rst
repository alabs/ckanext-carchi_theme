...
2. Install the ckanext-carchi_theme Python package into your virtual environment::
     ...
     pip install ckanext-carchi_theme
...
Document any optional config settings here. For example::
    ...
    # (optional, default: 24).
    ckanext.carchi_theme.some_setting = some_default_value
...
To install ckanext-carchi_theme for development, activate your CKAN virtualenv and
do::

    git clone https://github.com/apardo/ckanext-carchi_theme.git
...
coverage installed in your virtualenv (``pip install coverage``) then run::
    ...
    nosetests --nologcapture --with-pylons=test.ini --with-coverage --cover-package=ckanext.carchi_theme --cover-inclusive --cover-erase --cover-tests


---------------------------------
Registering ckanext-carchi_theme on PyPI
---------------------------------

ckanext-carchi_theme should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-carchi_theme. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-carchi_theme
----------------------------------------

ckanext-carchi_theme is availabe on PyPI as https://pypi.python.org/pypi/ckanext-carchi_theme.
